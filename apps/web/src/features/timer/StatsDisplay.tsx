...
const StatsDisplay: React.FC<StatsDisplayProps> = ({ stats, runningAO5, runningAO12 }) => {
    ...
    return (
        <div className="py-8 w-full max-w-2xl mx-auto text-xl text-foreground/60 font-sans tracking-wide space-y-1">
            <div className="flex justify-center space-x-10 uppercase font-bold">
