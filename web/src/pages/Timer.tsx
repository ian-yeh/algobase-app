...
const Timer = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-full overflow-y-auto md:overflow-hidden">
            ...
            <aside className={`w-full md:w-80 shrink-0 border-t md:border-t-0 md:border-l border-foreground/5 max-h-80 md:max-h-none md:h-full transition-opacity duration-300 ${isTiming ? 'hidden md:block md:opacity-0 md:pointer-events-none' : 'opacity-100'}`}>
                <SolveHistory
                    solves={solves}
